...
$quary  = $connect->prepare("select * from users");
$quary->execute();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  # code...
  $id = $_POST["id"];
  $quary = $connect->prepare("UPDATE `users` SET `role` = 'admin' WHERE `users`.`id` =$id ;");
  $quary->execute();
            ...
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="../employees/view.php" class="sidebar-link"
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="../department/view.php" class="sidebar-link"
                      ><i class="mdi mdi-note-outline"></i
